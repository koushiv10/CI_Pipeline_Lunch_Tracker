...
set CLASSPATH=%APP_HOME%\lib\webapp-0.1-all.jar

@rem Execute webapp
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WEBAPP_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%WEBAPP_EXIT_CONSOLE%" exit 1
exit /b 1
